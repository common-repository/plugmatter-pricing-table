  <div id='pmpt_container_{{container_editor}}' class='pmpt_container pmpt_simple' pmpt_meta_id='{{this.pmpt_tname}}'>
		{{#each pmpt_packages}}
			<div class='{{../pmpt_bs_cls}} {{column_space ../pmpt_ttype this.pmpt_featured}} pmpt_no_padding'>
				<div class='pmpt_column {{#if this.pmpt_featured}} pmpt_feature_column {{overlap_space ../../pmpt_ttype this.pmpt_featured}} {{else}} pmpt_column_{{@index}} {{/if}}' data-col-index='{{@index}}'>
					<div class='pmpt_header pmpt_header_{{@index}}'>
						<div class="pmpt_head_main" style="width:49%;display:inline-block;position:relative;text-align:left;">
						...
						<div class="pmpt_pricing_head" style="width:49%;display:inline-block;position:relative;text-align:right;">
					...
					{{#each this.pmpt_features}}
						<div id='pmpt_cell_{{@../index}}{{@index}}' class='pmpt_cell pmpt_cell_{{@../index}}{{@index}}' data-col-index='{{@../index}}' data-cell-index='{{@index}}' data-feature='{{feature_name ../../pmpt_features_list @index}}' data-tooltip="{{this.pmpt_tooltip}}"> 
							{{{this.pmpt_value}}}
